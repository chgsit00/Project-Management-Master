...
var o38454 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38454["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38455 = temp__4655__auto____$1;
return (o38455["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37600__auto__ = f;
return (o__37600__auto__["toString"]).call(o__37600__auto__);
} else {
return "";
}
}catch (e38456){var _ = e38456;
return "";
}});
...
try{var o__37600__auto___38458 = t;
(o__37600__auto___38458["cljs$lang$ctorPrWriter"]).call(o__37600__auto___38458,t,writer);
}catch (e38457){var __38459 = e38457;
}
...
var char_code = (function (){var o__37600__auto__ = (new String(char$));
return (o__37600__auto__["charCodeAt"]).call(o__37600__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37600__auto__ = String;
return (o__37600__auto__["fromCharCode"]).call(o__37600__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38460 = num_code;
switch (G__38460) {
case (1):
return (185);
...
var o__37600__auto__ = String;
return (o__37600__auto__["fromCharCode"]).call(o__37600__auto__,superscript_code);
});
/**
...
}catch (e38462){var _e__37607__auto__ = e38462;
return false;
}})())){
...
var vec__38463 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38463,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o38466 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38466["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38467 = temp__4655__auto____$1;
return (o38467["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29222__auto___38474 = arguments.length;
var i__29223__auto___38475 = (0);
while(true){
if((i__29223__auto___38475 < len__29222__auto___38474)){
args__29229__auto__.push((arguments[i__29223__auto___38475]));

var G__38476 = (i__29223__auto___38475 + (1));
i__29223__auto___38475 = G__38476;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38470){
var vec__38471 = p__38470;
var ns_detector = cljs.core.nth.call(null,vec__38471,(0),null);
...
var G__38477 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38478 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38477;
remaining_tokens = G__38478;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38468){
var G__38469 = cljs.core.first.call(null,seq38468);
var seq38468__$1 = cljs.core.next.call(null,seq38468);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38469,seq38468__$1);
});
...
var vec__38482 = cljs.core.split_with.call(null,(function (p1__38481_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38481_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38482,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38482,(1),null);
...
var vec__38485 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38485,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38485,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38488 = cljs.core.rest.call(null,remaining_tokens);
var G__38489 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38488;
name_tokens = G__38489;
continue;
} else {
...
var vec__38492 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38492,(0),null);
var arity = cljs.core.nth.call(null,vec__38492,(1),null);
var vec__38495 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38495,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38495,(1),null);
var vec__38498 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38498,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38498,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38498,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38498,(3),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38508 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38508,(0),null);
var args = cljs.core.nth.call(null,vec__38508,(1),null);
var vec__38511 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38511,(0),null);
var name = cljs.core.nth.call(null,vec__38511,(1),null);
...
var G__38514 = (arity + (1));
var G__38515 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38516){
var vec__38517 = p__38516;
var arity = cljs.core.nth.call(null,vec__38517,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38517,(1),null);
...
return cljs.core.get.call(null,arities,p1__38520_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38521_SHARP_);
...
var args__29229__auto__ = [];
var len__29222__auto___38528 = arguments.length;
var i__29223__auto___38529 = (0);
while(true){
if((i__29223__auto___38529 < len__29222__auto___38528)){
args__29229__auto__.push((arguments[i__29223__auto___38529]));

var G__38530 = (i__29223__auto___38529 + (1));
i__29223__auto___38529 = G__38530;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38524){
var vec__38525 = p__38524;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38525,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38522){
var G__38523 = cljs.core.first.call(null,seq38522);
var seq38522__$1 = cljs.core.next.call(null,seq38522);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38523,seq38522__$1);
});
...
var G__38531 = arg;
var G__38531__$1 = (((G__38531 instanceof cljs.core.Keyword))?G__38531.fqn:null);
switch (G__38531__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38533__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38533__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38533__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38533__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38534 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38534,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38534,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38534,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38534,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38534,(4),null);
var arity = cljs.core.nth.call(null,vec__38534,(5),null);
...
var o__37600__auto__ = f;
return (o__37600__auto__["getBasis"]).call(o__37600__auto__);
});
/**
...
}catch (e38538){var _e__37607__auto__ = e38538;
...
var G__38539 = (obj[cljs.core.first.call(null,path)]);
var G__38540 = cljs.core.rest.call(null,path);
obj = G__38539;
path = G__38540;
continue;
} else {
...
return (function (accum,p__38541){
var vec__38542 = p__38541;
var bit = cljs.core.nth.call(null,vec__38542,(0),null);
var protocol = cljs.core.nth.call(null,vec__38542,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38545){
var vec__38546 = p__38545;
var ns = cljs.core.nth.call(null,vec__38546,(0),null);
var name = cljs.core.nth.call(null,vec__38546,(1),null);
var selector = cljs.core.nth.call(null,vec__38546,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__38551,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38551,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38551,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38549_SHARP_){
return (obj[cljs.core.first.call(null,p1__38549_SHARP_)]);
});})(name,sorted_matches,vec__38551,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1518027926050
