...
var len__29222__auto___38585 = arguments.length;
var i__29223__auto___38586 = (0);
while(true){
if((i__29223__auto___38586 < len__29222__auto___38585)){
args__29229__auto__.push((arguments[i__29223__auto___38586]));

var G__38587 = (i__29223__auto___38586 + (1));
i__29223__auto___38586 = G__38587;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38582){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38583,G__38584,seq38582__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38588_SHARP_){
return !((cljs.core.meta.call(null,p1__38588_SHARP_) == null));
})))){
...
}catch (e38593){var _e__37607__auto__ = e38593;
return false;
}})();
if(cljs.core.truth_(or__28051__auto__)){
return or__28051__auto__;
...
}catch (e38595){var _e__37607__auto__ = e38595;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38597 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38598 = opts;
var map__38598__$1 = ((((!((map__38598 == null)))?((((map__38598.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38598.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38598):map__38598);
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38597;
}});
...
;
var temp__4655__auto___38602 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___38602)){
var managed_print_level_38603 = temp__4655__auto___38602;
var _STAR_print_level_STAR_38601_38604 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38603;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38601_38604,managed_print_level_38603,temp__4655__auto___38602,writer,opts,job_fn){
return (function (p1__38600_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38600_SHARP_,null);
});})(_STAR_print_level_STAR_38601_38604,managed_print_level_38603,temp__4655__auto___38602,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38601_38604;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1518027926540
