...
\begin{figure}[h]
	\centering
	\includegraphics[width=.6\textwidth]{../images/CostAnalysis/synologyFS1018} % TO BE CHANGED WHEN IN ORIGINAL MASTER
	\caption{NAS}
	\label{fig:nas}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.4\textwidth]{../images/CostAnalysis/lupusecBewegungsmelder} 
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.5\textwidth]{../images/CostAnalysis/LenovoHW01} 
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.5\textwidth]{../images/CostAnalysis/elgato-eve-thermo} 
...
\section{HMI Tablets}
%TODO: iPads für Reinigungskraft und Status Einstellungen für Mitarbeiter
