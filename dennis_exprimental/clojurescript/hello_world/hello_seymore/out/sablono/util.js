...
var len__29158__auto___29621 = arguments.length;
var i__29159__auto___29622 = (0);
while(true){
if((i__29159__auto___29622 < len__29158__auto___29621)){
args__29165__auto__.push((arguments[i__29159__auto___29622]));

var G__29623 = (i__29159__auto___29622 + (1));
i__29159__auto___29622 = G__29623;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq29620){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29620));
});
...
var vec__29624 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__29626;
var words = seq__29625__$1;
...
var G__29627 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__29627,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__29627;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__29628_SHARP_){
if(typeof p1__29628_SHARP_ === 'string'){
return p1__29628_SHARP_;
} else {
return cljs.core.seq.call(null,p1__29628_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1517063728856
