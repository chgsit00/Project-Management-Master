...
return (new CustomEvent(event_name,(function (){var obj35282 = {"detail":data};
return obj35282;
})()));
} else {
...
var f = (function (){var pred__35289 = cljs.core._EQ_;
var expr__35290 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35289.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35290))){
return ((function (pred__35289,expr__35290){
return (function (p1__35283_SHARP_){
return console.warn(p1__35283_SHARP_);
});
;})(pred__35289,expr__35290))
} else {
if(cljs.core.truth_(pred__35289.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35290))){
return ((function (pred__35289,expr__35290){
return (function (p1__35284_SHARP_){
return console.debug(p1__35284_SHARP_);
});
;})(pred__35289,expr__35290))
} else {
if(cljs.core.truth_(pred__35289.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35290))){
return ((function (pred__35289,expr__35290){
return (function (p1__35285_SHARP_){
return console.error(p1__35285_SHARP_);
});
;})(pred__35289,expr__35290))
} else {
return ((function (pred__35289,expr__35290){
return (function (p1__35286_SHARP_){
return console.log(p1__35286_SHARP_);
});
;})(pred__35289,expr__35290))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35293){
...
var eval_fn = cljs.core.get.call(null,map__35294__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35296_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35298,(0),null);
...
}catch (e35303){if((e35303 instanceof Error)){
var e = e35303;
return not_found;
} else {
throw e35303;
...
//# sourceMappingURL=utils.js.map?rel=1517063740514
