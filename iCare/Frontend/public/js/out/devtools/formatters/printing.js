...
var len__29222__auto___38445 = arguments.length;
var i__29223__auto___38446 = (0);
while(true){
if((i__29223__auto___38446 < len__29222__auto___38445)){
args__29229__auto__.push((arguments[i__29223__auto___38446]));

var G__38447 = (i__29223__auto___38446 + (1));
i__29223__auto___38446 = G__38447;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38442){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38443,G__38444,seq38442__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38448_SHARP_){
return !((cljs.core.meta.call(null,p1__38448_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__38449__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e38453){var _e__37467__auto__ = e38453;
return false;
}})();
if(cljs.core.truth_(or__28051__auto__)){
return or__28051__auto__;
...
}catch (e38455){var _e__37467__auto__ = e38455;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38457 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38458 = opts;
...
var markup_db = cljs.core.get.call(null,map__38458__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38457;
}});
...
;
var temp__4655__auto___38462 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___38462)){
var managed_print_level_38463 = temp__4655__auto___38462;
var _STAR_print_level_STAR_38461_38464 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38463;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38461_38464,managed_print_level_38463,temp__4655__auto___38462,writer,opts,job_fn){
return (function (p1__38460_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38460_SHARP_,null);
});})(_STAR_print_level_STAR_38461_38464,managed_print_level_38463,temp__4655__auto___38462,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38461_38464;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1517067026705
