...
var len__29222__auto___38436 = arguments.length;
var i__29223__auto___38437 = (0);
while(true){
if((i__29223__auto___38437 < len__29222__auto___38436)){
args__29229__auto__.push((arguments[i__29223__auto___38437]));

var G__38438 = (i__29223__auto___38437 + (1));
i__29223__auto___38437 = G__38438;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq38434){
var G__38435 = cljs.core.first.call(null,seq38434);
var seq38434__$1 = cljs.core.next.call(null,seq38434);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38435,seq38434__$1);
});
...
return (p1__38439_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1517067026536
