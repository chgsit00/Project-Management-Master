...
var G__38416 = devtools.prefs.pref.call(null,v);
v = G__38416;
continue;
} else {
return v;
...
}catch (e38419){var _e__37467__auto__ = e38419;
return false;
}})();
...
}catch (e38423){var _e__37467__auto__ = e38423;
return false;
}})();
...
}catch (e38425){var _e__37467__auto__ = e38425;
return false;
}}
}
});
...
var vec__38427 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__38427,(0),null);
var name = cljs.core.nth.call(null,vec__38427,(1),null);
...
return cljs.core.some.call(null,(function (p1__38430_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38430_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1517067026479
