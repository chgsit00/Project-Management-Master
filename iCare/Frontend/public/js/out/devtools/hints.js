...
}catch (e39129){var _e = e39129;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___39132 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___39132)){
var seen_errors_39133 = temp__4655__auto___39132;
if(cljs.core.truth_(seen_errors_39133.has(self))){
} else {
seen_errors_39133.add(self);

var temp__4657__auto___39134 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___39134)){
var sense_39135 = temp__4657__auto___39134;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39135)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1517067028574
