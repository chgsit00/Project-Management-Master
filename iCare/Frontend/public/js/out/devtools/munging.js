...
var o38314 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38314["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38315 = temp__4655__auto____$1;
return (o38315["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37460__auto__ = f;
return (o__37460__auto__["toString"]).call(o__37460__auto__);
} else {
return "";
}
}catch (e38316){var _ = e38316;
return "";
}});
...
try{var o__37460__auto___38318 = t;
(o__37460__auto___38318["cljs$lang$ctorPrWriter"]).call(o__37460__auto___38318,t,writer);
}catch (e38317){var __38319 = e38317;
}
...
var char_code = (function (){var o__37460__auto__ = (new String(char$));
return (o__37460__auto__["charCodeAt"]).call(o__37460__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37460__auto__ = String;
return (o__37460__auto__["fromCharCode"]).call(o__37460__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38320 = num_code;
switch (G__38320) {
case (1):
return (185);
...
var o__37460__auto__ = String;
return (o__37460__auto__["fromCharCode"]).call(o__37460__auto__,superscript_code);
});
/**
...
}catch (e38322){var _e__37467__auto__ = e38322;
return false;
}})())){
...
var vec__38323 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38323,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o38326 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38326["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38327 = temp__4655__auto____$1;
return (o38327["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29222__auto___38334 = arguments.length;
var i__29223__auto___38335 = (0);
while(true){
if((i__29223__auto___38335 < len__29222__auto___38334)){
args__29229__auto__.push((arguments[i__29223__auto___38335]));

var G__38336 = (i__29223__auto___38335 + (1));
i__29223__auto___38335 = G__38336;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38330){
var vec__38331 = p__38330;
var ns_detector = cljs.core.nth.call(null,vec__38331,(0),null);
...
var G__38337 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38338 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38337;
remaining_tokens = G__38338;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38328){
var G__38329 = cljs.core.first.call(null,seq38328);
var seq38328__$1 = cljs.core.next.call(null,seq38328);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38329,seq38328__$1);
});
...
var vec__38342 = cljs.core.split_with.call(null,(function (p1__38341_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38341_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38342,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38342,(1),null);
...
var vec__38345 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38345,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38345,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38348 = cljs.core.rest.call(null,remaining_tokens);
var G__38349 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38348;
name_tokens = G__38349;
continue;
} else {
...
var vec__38352 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38352,(0),null);
var arity = cljs.core.nth.call(null,vec__38352,(1),null);
var vec__38355 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38355,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38355,(1),null);
var vec__38358 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38358,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38358,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38358,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38358,(3),null);
...
var vec__38364 = result;
var munged_ns = cljs.core.nth.call(null,vec__38364,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38364,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38364,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38364,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38364,(4),null);
var arity = cljs.core.nth.call(null,vec__38364,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38368 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38368,(0),null);
var args = cljs.core.nth.call(null,vec__38368,(1),null);
var vec__38371 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38371,(0),null);
var name = cljs.core.nth.call(null,vec__38371,(1),null);
...
var G__38374 = (arity + (1));
var G__38375 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38376){
var vec__38377 = p__38376;
var arity = cljs.core.nth.call(null,vec__38377,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38377,(1),null);
...
return cljs.core.get.call(null,arities,p1__38380_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38381_SHARP_);
...
var args__29229__auto__ = [];
var len__29222__auto___38388 = arguments.length;
var i__29223__auto___38389 = (0);
while(true){
if((i__29223__auto___38389 < len__29222__auto___38388)){
args__29229__auto__.push((arguments[i__29223__auto___38389]));

var G__38390 = (i__29223__auto___38389 + (1));
i__29223__auto___38389 = G__38390;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38384){
var vec__38385 = p__38384;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38385,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38382){
var G__38383 = cljs.core.first.call(null,seq38382);
var seq38382__$1 = cljs.core.next.call(null,seq38382);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38383,seq38382__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38393__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38393__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38393__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38393__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38394 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38394,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38394,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38394,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38394,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38394,(4),null);
var arity = cljs.core.nth.call(null,vec__38394,(5),null);
...
var o__37460__auto__ = f;
return (o__37460__auto__["getBasis"]).call(o__37460__auto__);
});
/**
...
}catch (e38398){var _e__37467__auto__ = e38398;
...
var G__38399 = (obj[cljs.core.first.call(null,path)]);
var G__38400 = cljs.core.rest.call(null,path);
obj = G__38399;
path = G__38400;
continue;
} else {
...
return (function (accum,p__38401){
var vec__38402 = p__38401;
var bit = cljs.core.nth.call(null,vec__38402,(0),null);
var protocol = cljs.core.nth.call(null,vec__38402,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38405){
...
var selector = cljs.core.nth.call(null,vec__38406,(2),null);
...
return (function (p__38410){
var vec__38411 = p__38410;
var munged_name = cljs.core.nth.call(null,vec__38411,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38411,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38411,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38409_SHARP_){
return (obj[cljs.core.first.call(null,p1__38409_SHARP_)]);
});})(name,sorted_matches,vec__38411,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1517067026317
